...
import sylvantus.titanrealms.core.world.feature.TitanRealmsTreeGenerator;
...
public class FeatureUtils {
    ...
    public static boolean canRootGrowIn(IWorldReader world, BlockPos pos) {
        ...
        if (blockState.isAir(world, pos)) {
            ...
            return FeatureUtils.isNearSolid(world, pos);
        } else {
     ...
     * This takes all variables for setting Branch
     */
    public static void drawBresenhamBranch(TitanRealmsTreeGenerator<? extends TreeFeatureConfig> generator, IWorld world, Random random, BlockPos from, BlockPos to, Set<BlockPos> state, MutableBoundingBox mbb, TreeFeatureConfig config) {
        for (BlockPos pixel : getBresenhamArrays(from, to)) {
    ...
    /**
     * Get an array of values that represent a line from point A to point B
     * TODO: lazify this into an iterable?
     */
