...
public class ItemDeferredRegister extends WrappedDeferredRegister<Item> {
    ...
    public static Item.Properties getTRBaseProperties() {
        return new Item.Properties().group(TitanRealms.tabTitanRealms);
    }
    ...
    public <ITEM extends Item> ItemRegistryObject<ITEM> register(String name, Function<Item.Properties, ITEM> sup) {
        return register(name, () -> sup.apply(getTRBaseProperties()));
    }

    public <ITEM extends Item> ItemRegistryObject<ITEM> registerUnburnable(String name, Function<Item.Properties, ITEM> sup) {
        return register(name, () -> sup.apply(getTRBaseProperties().isImmuneToFire()));
    }
