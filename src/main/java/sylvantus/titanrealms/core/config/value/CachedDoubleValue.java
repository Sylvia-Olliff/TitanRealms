...
public class CachedDoubleValue extends CachedPrimitiveValue<Double> implements DoubleSupplier {
    ...
    private CachedDoubleValue(ITitanRealmsConfig config, ConfigValue<Double> internal) {
        super(config, internal);
    }

    public static CachedDoubleValue wrap(ITitanRealmsConfig config, ConfigValue<Double> internal) {
