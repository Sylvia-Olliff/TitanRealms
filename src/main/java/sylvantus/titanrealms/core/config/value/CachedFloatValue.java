...
//TODO: Once https://github.com/MinecraftForge/MinecraftForge/pull/7395 is merged make this extend CachedPrimitiveValue<Float>
...
public class CachedFloatValue extends CachedPrimitiveValue<Double> implements FloatSupplier {
    ...
    private CachedFloatValue(ITitanRealmsConfig config, ConfigValue<Double> internal) {
        super(config, internal);
    }

    public static CachedFloatValue wrap(ITitanRealmsConfig config, ConfigValue<Double> internal) {
