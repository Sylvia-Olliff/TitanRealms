...
public class CachedResourceLocationListValue extends CachedResolvableConfigValue<List<ResourceLocation>, List<? extends String>> {
    ...
    private CachedResourceLocationListValue(ITitanRealmsConfig config, ConfigValue<List<? extends String>> internal) {
        super(config, internal);
    }

    public static CachedResourceLocationListValue wrap(ITitanRealmsConfig config, ConfigValue<List<? extends String>> internal) {
