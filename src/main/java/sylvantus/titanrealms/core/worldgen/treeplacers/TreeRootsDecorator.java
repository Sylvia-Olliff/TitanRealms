package sylvantus.titanrealms.core.worldgen.treeplacers;
...
import sylvantus.titanrealms.core.worldgen.TitanRealmsFeatures;
...
public class TreeRootsDecorator extends TreeDecorator {
    ...
    protected TreeDecoratorType<TreeRootsDecorator> func_230380_a_() {
        return TitanRealmsFeatures.TREE_ROOTS;
    }
    ...
    protected void buildRootWithAir(ISeedReader world, Random random, BlockPos pos, Set<BlockPos> decorations, double offset, int iteration, int length, MutableBoundingBox mutableBoundingBox, BlockStateProvider airRoot, BlockStateProvider dirtRoot) {
        BlockPos dest = FeatureUtils.translate(pos.down(iteration + 2), length, 0.3 * iteration + offset, 0.8);
