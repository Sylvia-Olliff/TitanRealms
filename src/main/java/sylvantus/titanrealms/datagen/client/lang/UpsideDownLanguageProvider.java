...
import sylvantus.titanrealms.datagen.client.lang.FormatSplitter.FormatComponent;
import sylvantus.titanrealms.datagen.client.lang.FormatSplitter.MessageFormatComponent;
import net.minecraft.data.DataGenerator;

import java.text.ChoiceFormat;
import java.util.List;

public class UpsideDownLanguageProvider extends ConvertableLanguageProvider {

    public UpsideDownLanguageProvider(DataGenerator gen, String modid) { super(gen, modid, "en_ud"); }
    ...
    private static String convertMessageFormatCode(MessageFormatComponent component) {
        ...
        if (formatStyle != null && component.isChoice()) {
            ...
            try {
                ...
                TitanRealms.LOGGER.warn("Failed to convert '{}' to an upside down choice format. Got: '{}' which was invalid.", formatStyle, newFormatStyle);
