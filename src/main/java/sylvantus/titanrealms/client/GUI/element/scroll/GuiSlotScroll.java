...
import sylvantus.titanrealms.client.GUI.element.GuiRelativeElement;
...
import sylvantus.titanrealms.core.util.interfaces.containers.ISlotClickHandler;
import sylvantus.titanrealms.core.util.interfaces.containers.ISlotClickHandler.IScrollableSlot;

public class GuiSlotScroll extends GuiRelativeElement {

    private static final ResourceLocation SLOTS = TitanRealmsUtils.getResource(ResourceType.GUI_SLOT, "slots.png");
    private static final ResourceLocation SLOTS_DARK = TitanRealmsUtils.getResource(ResourceType.GUI_SLOT, "slots_dark.png");
