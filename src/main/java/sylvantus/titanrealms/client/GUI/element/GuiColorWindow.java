...
import sylvantus.titanrealms.client.GUI.element.button.TranslationButton;
import sylvantus.titanrealms.client.GUI.element.text.BackgroundType;
import sylvantus.titanrealms.client.GUI.element.text.GuiTextField;
import sylvantus.titanrealms.client.GUI.element.text.InputValidator;
...
import sylvantus.titanrealms.core.util.TextUtils;
...
public class GuiColorWindow extends GuiWindow {
    ...
    private static final ResourceLocation HUE_PICKER = TitanRealmsUtils.getResource(ResourceType.GUI, "color_picker.png");
    ...
    public GuiColorWindow(IGuiWrapper gui, int x, int y, Consumer<Color> callback) {
        ...
        addChild(new TranslationButton(gui, x + 100, y + getButtonHeight() - 21, 54, 14, TitanRealmsLang.BUTTON_CONFIRM, () -> {
    ...
    public void renderForeground(MatrixStack matrix, int mouseX, int mouseY) {
        ...
        drawCenteredTextScaledBound(matrix, TitanRealmsLang.COLOR_PICKER.translate(), 120, 6, titleTextColor());
        drawTextScaledBound(matrix, TitanRealmsLang.RGB.translate(), relativeX + 7, relativeY + getButtonHeight() - 17.5F, titleTextColor(), 20);
    }
    ...
    public class GuiColorView extends GuiRelativeElement {
        ...
        public void renderToolTip(@Nonnull MatrixStack matrix, int mouseX, int mouseY) {
            ...
            ITextComponent hex = TitanRealmsLang.GENERIC_HEX.translateColored(EnumColor.GRAY, TextUtils.hex(false, 3, getColor().rgb()));
