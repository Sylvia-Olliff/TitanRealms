...
import sylvantus.titanrealms.client.GUI.element.GuiScalableElement;
...
public abstract class GuiScrollList extends GuiScrollableElement {
    ...
    protected static final ResourceLocation SCROLL_LIST = TitanRealmsUtils.getResource(ResourceType.GUI, "scroll_list.png");
