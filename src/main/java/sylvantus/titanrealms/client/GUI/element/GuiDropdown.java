...
import sylvantus.titanrealms.core.util.interfaces.GuiComponents.IDropdownEnum;
...
public class GuiDropdown<TYPE extends Enum<TYPE> & IDropdownEnum<TYPE>> extends GuiTexturedElement {
    ...
    public void onClick(double mouseX, double mouseY) {
        ...
        minecraft.getSoundHandler().play(SimpleSound.master(TitanRealmsSounds.BEEP.get(), 1.0F));
    }
