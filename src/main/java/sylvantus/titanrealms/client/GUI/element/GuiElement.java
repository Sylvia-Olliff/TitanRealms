...
public abstract class GuiElement extends Widget implements IFancyFontRenderer {
    ...
    public final void onRenderForeground(MatrixStack matrix, int mouseX, int mouseY, int zOffset, int totalOffset) {
        if (visible) {
            ...
            GuiTitanRealms.maxZOffset = Math.max(totalOffset, GuiTitanRealms.maxZOffset);
    ...
    protected void drawButton(MatrixStack matrix, int mouseX, int mouseY) {
        ...
        TitanRealmsRenderer.bindTexture(buttonBackground.getTexture());
    ...
    public enum ButtonBackground {
        DEFAULT(TitanRealmsUtils.getResource(ResourceType.GUI, "button.png")),
        DIGITAL(TitanRealmsUtils.getResource(ResourceType.GUI, "button_digital.png")),
        NONE(null);
