...
public abstract class GuiBar<INFO extends GuiBar.IBarInfoHandler> extends GuiTexturedElement {

    public static final ResourceLocation BAR = TitanRealmsUtils.getResource(ResourceType.GUI_BAR, "base.png");
