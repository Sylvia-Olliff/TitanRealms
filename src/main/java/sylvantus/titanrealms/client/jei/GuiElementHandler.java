...
import sylvantus.titanrealms.client.jei.interfaces.IJEIIngredientHelper;
...
public class GuiElementHandler implements IGuiContainerHandler<GuiTitanRealms<?>> {
    ...
    @Override
    public List<Rectangle2d> getGuiExtraAreas(GuiTitanRealms<?> gui) {
    ...
    @Nullable
    @Override
    public Object getIngredientUnderMouse(GuiTitanRealms<?> gui, double mouseX, double mouseY) {
    ...
    @Override
    public Collection<IGuiClickableArea> getGuiClickableAreas(GuiTitanRealms<?> gui, double mouseX, double mouseY) {
