package sylvantus.titanrealms.client.render.tileentity;
...
public abstract class TitanRealmsTileEntityRenderer<TILE extends TileEntity> extends TileEntityRenderer<TILE> {

    protected TitanRealmsTileEntityRenderer(TileEntityRendererDispatcher renderer) {
        super(renderer);
    }
