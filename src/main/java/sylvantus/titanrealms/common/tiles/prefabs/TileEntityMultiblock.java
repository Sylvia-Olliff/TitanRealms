...
import sylvantus.titanrealms.client.SparkleAnimation;
...
import sylvantus.titanrealms.core.lib.multiblock.MultiblockCache;
...
public abstract class TileEntityMultiblock<T extends MultiblockData> extends TileEntityTitanRealms implements IMultiblock<T>, IConfigurable {
